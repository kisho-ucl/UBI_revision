...
DCL & 0.420 & 0.705 \\
CNN-T & 0.363 & 0.694 \\
PreCNN-T & \textbf{0.502} & \textbf{0.852} \\
\hline
\end{tabular}
\end{table}

\subsubsection{物流倉庫実作業データセット}
物流倉庫実作業データセットに対して，被験者を 1 名ずつテストデータとする被験者間交差検証を行い，提案手法の認識性能を評価した．\rev{表}\ref{tab:trusco_results}に各モデルについて全体の認識性能を示す．PreCNN および PreCNN-Tは，事前学習をしない場合と比べてMacro-F1，Weighted-F1 の両指標が向上しており，
