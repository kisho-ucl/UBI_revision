...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.92\linewidth, trim=10 37 10 15, bb=0 0 1407 520]{figure/overview.pdf} 
  \caption{\rev{特徴抽出器の自己教師あり学習を活用した作業認識モデルの概要（PreCNN-T）}}
  \label{fig:overview}
\end{figure*}
...
\subsubsection{\recv{SimCLRによる表現学習}}
\rev{本研究では，
...
\rev{自己教師あり学習の有効性，データ拡張設定の影響，
訓練ラベル量と認識精度の関係，および被験者間における汎化性能について評価する．}
さらに，\rev{本手法}の汎用性を確認するため，異なるデータセットを用いた検証も行う．
