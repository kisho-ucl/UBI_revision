...
\title{自己教師あり学習を用いた \\ IMUデータによる産業現場作業認識の実環境評価}
...
本研究では，IMUセンサを用いた作業認識における自己教師あり学習の活用について，
...
自己教師あり学習により事前学習した特徴抽出器と長期時系列モデルを組み合わせた作業認識モデルがベースラインを一貫して上回る認識性能が確認され，作業認識における自己教師あり学習を用いたラベルなしセンサデータ活用の実環境への適用可能性が示された．
\end{abstract}
