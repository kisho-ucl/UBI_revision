...
また，全被験者の予測を累計し，作業ごとの持続時間と認識性能の関係をまとめたものを表\ref{tab:cnn_vs_precnn_t}に示す．
まず，長期入力を扱うCNN-Tでは，Assemble Box（20.3 $\pm$ 7.0 [s]）やRelocate Item Label（18.2 $\pm$ 12.8 [s]）といった比較的長時間かつ持続時間のばらつきが大きい作業においても，高いF1スコア（それぞれ0.851，0.855）が観察された．
また，自己教師あり学習を導入したPreCNN-Tでは，全ての作業においてF1スコアが向上しており，長期的な時系列文脈に加えて，動作表現の質の向上が認識性能に寄与していることが示唆される．
...
\begin{table}[t]
\centering
\caption{作業の持続時間と認識スコアの比較（OpenPackデータセット）}
...
\cline{3-4}
 & & CNN-T & PreCNN-T \\
\hline
Assemble Box & 20.3 $\pm$ 7.0 & 0.851 & 0.909 \\
Relocate Item Label & 18.2 $\pm$ 12.8 & 0.855 & 0.901 \\
Scan Label & 17.0 $\pm$ 9.2 & 0.844 & 0.877 \\
Close Box & 13.2 $\pm$ 4.0 & 0.819 & 0.894 \\
Picking & 12.3 $\pm$ 6.0 & 0.830 & 0.869 \\
Insert Items & 11.7 $\pm$ 6.1 & 0.809 & 0.853 \\
Fill out Order & 10.1 $\pm$ 4.6 & 0.843 & 0.865 \\
Attach Shipping Label & 9.1 $\pm$ 3.0 & 0.873 & 0.901 \\
Put on Back Table & 6.0 $\pm$ 2.1 & 0.847 & 0.869 \\
Attach Box Label & 5.8 $\pm$ 2.3 & 0.670 & 0.758 \\
\hline
\end{tabular}
